...
- Added Concept-inspired editorial storefront styling
- Added optional generic demo catalog using redistributable SVG placeholders
- Removed non-redistributable branded product images and scraped catalog data
- Added original AI-generated controller demo imagery with no brand marks
- Replaced the single featured demo card with a horizontally scrollable all-products slider
